...
let fake = process.env.OWNER_NUMBER === undefined ? '94742514900' : process.env.OWNER_NUMBER
global.owner = [`${fake}`]
global.ownernumber = [`${fake}`]
global.premium = [`${fake}`]
global.anticall = process.env.ANTICALL === undefined ? 'false' : process.env.ANTICALL
global.packname = process.env.PACK_NAME === undefined ? '✿Ƈʜᴀᴛʜᴜ ツ' : process.env.PACK_NAME
global.author = process.env.STICKER_AUTHOR_NAME === undefined ? '✿Ƈʜᴀᴛʜᴜ ツ' : process.env.STICKER_AUTHOR_NAME
